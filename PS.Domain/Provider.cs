...
namespace PS.Domain
{
    public class Provider : Concept
    {
        [Required]
        [MinLength(8)]
        [DataType(DataType.Password,ErrorMessage ="Check your Damn Password Fool!")]
        String password;
        ...
        [DataType(DataType.EmailAddress,ErrorMessage ="this email must be valid and it's a required field")]
        [Required]
