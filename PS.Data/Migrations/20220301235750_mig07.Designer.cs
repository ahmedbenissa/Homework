...
namespace PS.Data.Migrations
{
    ...
    [Migration("20220301235750_mig07")]
    partial class mig07
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PS.Domain.Departement", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PS.Domain.Employee", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DepartementEmployee", b =>
                {
                    b.HasOne("PS.Domain.Departement", null)
                        .WithMany()
                        .HasForeignKey("departementsid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PS.Domain.Employee", null)
                        .WithMany()
